    ...
    >
        ...
        <div className="flex items-stretch h-19">
          ...
          <div className="flex items-center px-4 mr-4 border-r border-l border-[#543F3A]/[0] md:border-[#543F3A]/[.07]">
            <Link href="/" className="text-base font-semibold tracking-tight">
              <Image src="/MusyncLogoSVG.svg" alt="Musync" width={138} height={51} />
      ...
      >
        <div className="px-4 border-b border-[#E1D8D4]">
          ...
          <div
            className={`w-full flex items-center justify-between py-7 text-lg font-medium border-b border-[#E1D8D4] ${
          ...
          >
            ...
            >
              <Arrow rotated={isFeaturesOpen} isMobile={true} />
            </button>
          </div>
          <div
          ...
          >
            <Link href="/product-features/music-on-the-go" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Music On The Go</Link>
            <Link href="/product-features/collaborate" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Collaborate</Link>
            <Link href="/product-features/unsheet-music" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">(Un)sheet Music</Link>
            <Link href="/product-features/practice-and-perform" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Practice and Perform</Link>
            <Link href="/product-features/musync-intelligence" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Musync Intelligence</Link>
          </div>
          ...
          <Link
            href="/pricing"
            onClick={closeMobile}
            className="block py-7 px-4 text-lg font-medium border-b border-[#E1D8D4]"
          >
            Pricing
          </Link>
          ...
          >
            ...
            >
              <Arrow rotated={isHelpOpen} isMobile={true} />
            </button>
          </div>
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${
          ...
          >
            <Link href="/help/tutorial-videos" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Tutorial Videos</Link>
            <Link href="/help/wiki" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Wiki</Link>
            <Link href="/help/faq" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">FAQ</Link>
          </div>
          ...
          >
            ...
            >
              <Arrow rotated={isCompanyOpen} isMobile={true} />
            </button>
          </div>
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${
          ...
          >
            <Link href="/company/about" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">About</Link>
            <Link href="/company/why-musyncs" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Why Musyncs</Link>
            <Link href="/company/contact" onClick={closeMobile} className="block px-4 py-4 text-lg border-b border-[#E1D8D4] bg-[#F3EFEE]">Contact</Link>
          </div>
